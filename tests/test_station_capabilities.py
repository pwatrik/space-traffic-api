...
def test_route_filtering_respects_station_size_class_capabilities():
    custom_catalog = {
        "celestial": {
            "planets": ["Earth"],
            "moons": [
    ...
    with TemporaryDirectory() as tmp:
        ...
        os.environ["SPACE_TRAFFIC_DB_PATH"] = db_path
        os.environ["SPACE_TRAFFIC_API_KEY"] = "test-key"
        os.environ["SPACE_TRAFFIC_DISABLE_GENERATOR"] = "false"
        os.environ["SPACE_TRAFFIC_SEED_CATALOG_PATH"] = catalog_path
        os.environ["SPACE_TRAFFIC_DETERMINISTIC_MODE"] = "true"
        os.environ["SPACE_TRAFFIC_MIN_EVENTS_PER_MIN"] = "60"
        os.environ["SPACE_TRAFFIC_MAX_EVENTS_PER_MIN"] = "60"
        ...
        try:
            ...
            os.environ.pop("SPACE_TRAFFIC_SEED_CATALOG_PATH", None)
            os.environ.pop("SPACE_TRAFFIC_DETERMINISTIC_MODE", None)
            os.environ.pop("SPACE_TRAFFIC_MIN_EVENTS_PER_MIN", None)
            os.environ.pop("SPACE_TRAFFIC_MAX_EVENTS_PER_MIN", None)
            os.environ.pop("SPACE_TRAFFIC_DISABLE_GENERATOR", None)
